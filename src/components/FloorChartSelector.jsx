...
const heightt = window.innerWidth >500 ?500  : 350;
  ...
  return (
    <div className="chart-container w-full">
      <div className="chart-header ">
        <h2 className="text-lg font-bold text-[var(--text)] mb-5 mt-5 text-center">
          نمودار اطلاعات طبقات
        </h2>
      </div>
      ...
      {loading ? (
        ...
        <div className="chart-wrapper">
          <ResponsiveContainer width="100%" height={heightt}>
            {renderChart()}
          </ResponsiveContainer>
        </div>
      )}
