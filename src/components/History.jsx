      ...
      <section className="mt-3 border bg-white/50 backdrop-blur-md rounded-2xl shadow-md p-6 grid lg:grid-cols-4 gap-5">
        ...
        <div className="lg:col-span-2">
          <h3 className="text-3xl  w-full flex flex-row-reverse items-center text-right justify-end gap-2 font-modam font-extrabold text-[var(--text)] mb-4 leading-snug">
            17 شهریور شمالی ؛ از خاک زراعی تا بافت شهری
            <BookOpenIcon size={28} />
          </h3>

          <p className="md:leading-loose lg:leading-loose font-modam text-justify text-base ">
            محله 17شهریور شمالی، که با نام قدیمی‌اش <strong>" ینگه‌قلعه "</strong> و امروزه با
            عنوان <strong>" کلانتری ۱۱ " </strong> نیز شناخته می‌شود، در گذشته دور ؛ جزوی از
            زمین‌های زراعی و حاشیه‌ قدیمی شهر بوده است . این محله از دهه <strong>۱۳۵۰</strong>
            شمسی به‌تدریج شکل گرفت و بافت کوچه‌ها و قطعه‌بندی‌های آن، هنوز هم
            نشانه‌هایی از ساختار سنتی و گذشته‌ی آن را حفظ کرده است.
            <br />
            با نگاهی به عکس‌های هوایی سال‌های ۱۳۸۴ و ۱۴۰۴، می‌توان رشد و گسترش
            چشمگیر ساختمان‌ها و توسعه کالبدی محله را به‌وضوح مشاهده کرد؛ تحولی
            که نشان از پویایی و تغییرات سریع در این بخش از شهر دارد.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 w-full gap-5  lg:mt-7 lg:col-span-2 relative">
          ...
          >
            <img
              src={images[0].src}
              loading="lazy"
              alt={`محله هفده شهریور در سال ${images[0].year}`}
              className="rounded-xl shadow-md w-[150px] h-[150px] lg:max-w-[250px] object-cover"
            />
            <p className="text-center mt-3 text-orange-900 text-base leading-relaxed">
              محله هفده شهریور - سال {images[0].year}
            </p>
          </motion.div>
          ...
          >
            <img
              src={images[1].src}
              loading="lazy"
              alt={`محله هفده شهریور در سال ${images[1].year}`}
              className="rounded-xl shadow-md w-[150px] h-[150px] lg:max-w-[250px] object-cover"
            />
            <p className="text-center mt-3 text-orange-900 text-base leading-relaxed">
              محله هفده شهریور - سال {images[1].year}
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="relative max-w-3xl w-full px-4">
            ...
            <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-4 shadow-lg flex flex-col items-center">
              <img
                ...
                alt={`محله هفده شهریور - سال ${images[selectedImageIndex].year}`}
              ...
              <p className="mt-4 text-orange-900 text-lg font-semibold text-center">
                محله هفده شهریور - سال {images[selectedImageIndex].year}
              </p>
