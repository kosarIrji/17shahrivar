  ...
  return (
    ...
    <div className="flex flex-col overflow-hidden w-full items-center justify-center pt-3 my-3 border bg-white/50 backdrop-blur-md shadow-md p-4 py-5 rounded-2xl">
      ...
      <div className="w-full   flex flex-col lg:flex-row gap-[10px] justify-evenly xl:justify-center items-center">
        {/* Box 1 */}
        <div className="rounded-xl shadow p-4 flex flex-col items-center justify-between w-full max-w-xs h-[200px] bg-gradient-to-t  from-yellow-200 via-yellow-200 to-yellow-100 ">
        ...
        {/* Box 2 */}
        <div className="rounded-xl shadow p-4 flex flex-col  items-center justify-between w-full max-w-xs h-[200px] bg-gradient-to-t from-orange-900 via-orange-800 to-orange-700">
        ...
        {/* Box 3 */}
        <div className="rounded-xl shadow p-4 flex flex-col items-center justify-between w-full max-w-xs h-[200px] bg-gradient-to-t from-amber-50 via-amber-100 to-amber-100">
      ...
      <p className="text-gray-800   text-center  text-base">
        ...
        ریسک سرمایه‌گذاری در سطح <strong>متوسط</strong> است و <strong className="text-green-800">قیمت بالای املاک</strong> در کنار <strong className="text-green-800">موقعیت
        مناسب محله</strong>، پتانسیل سودآوری بالایی در آینده نشان می‌دهد.{" "}</span>
      </p>
      </div>
    </div>
  );
