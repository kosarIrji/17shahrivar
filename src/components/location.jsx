  ...
  return (
    ...
    >
      <motion.img
        ...
        loading="lazy"
        alt="محله  هفده شهریور در سال ۲۰۲۵"
      ...
      {windowHeight < 500 ? (
        ...
        >
          ...
          <p className="md:leading-loose lg:leading-loose font-modam  text-justify text-base  ">
            محله 17 شهریور شمالی با موقعیت عالی<strong className="text-blue-700"> نزدیک به مرکز شهر</strong> و دسترسی آسان
            به سایر نقاط شهر ، برای سکونت، فعالیت تجاری و تردد شهری بسیار مناسب
            است. این محله از شمال به بلوار شهدا، از غرب به خیابان 17 شهریور
            شمالی، از شرق به خیابان استقلال و از جنوب به خیابان طالقانی شرقی
            محدود م یشود .
          </p>
        </motion.div>
      ) : (
